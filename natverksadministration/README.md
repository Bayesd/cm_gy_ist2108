...
- [Windows Server](#windows-server)
  ...
  - [Det grafiska gränssnittet](#det-grafiska-gränssnittet)
    ...
    - [Powershell (lägg till i aktivitetsfältet)](#powershell-lägg-till-i-aktivitetsfältet)
      - [Även när Powershell nu är stängt så ligger ikonen lättillgänglig i aktivitetsfältet](#även-när-powershell-nu-är-stängt-så-ligger-ikonen-lättillgänglig-i-aktivitetsfältet)
  ...
  - [Praktiska uppgifter kapitel 1](#praktiska-uppgifter-kapitel-1)
    ...
    - [1.2 Lär känna Windows Server](#12-lär-känna-windows-server)
